...
const benefits = [
  {
    ...
    description:
      "Leveraging advanced machine learning to provide personalized career insights",
  },
  {
    icon: Shield,
    title: "Privacy First",
  ...
  },
  {
    ...
    description:
      "Join thousands of professionals who have transformed their careers with SKANJO",
  },
];
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
              SKANJO provides a comprehensive suite of AI-powered tools to
              optimize your CV, identify skill gaps, and create personalized
              learning paths.
            </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {benefits.map((benefit, index) => (
              <Card
                key={index}
                className="text-center bg-card/50 backdrop-blur-sm border-border/50 hover:shadow-xl transition-all duration-300"
              >
                <CardHeader>
