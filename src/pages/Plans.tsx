...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Our AI has been trained on millions of successful CV and job matching pairs, achieving 95%+ accuracy in skill gap identification.",
  },
];
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {plans.map((plan, index) => (
              <Card
                key={index}
                className={`relative flex flex-col overflow-hidden bg-card/50 backdrop-blur-sm border-border/50 transition-all duration-500 hover:shadow-2xl animate-fade-in ${
                  plan.popular
              ...
              >
                ...
                <CardHeader
                  className={`relative z-10 ${plan.popular ? "pt-12" : ""}`}
                >
                  <div
                    className={`inline-flex items-center justify-center w-12 h-12 rounded-xl ${plan.bgColor} mb-4`}
                  >
